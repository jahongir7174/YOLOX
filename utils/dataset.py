    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            if random.random() < params['mix_up']:
                ...
                image, label = mix_up(mix_image1, mix_label1,
                                      mix_image2, mix_label2)
        else:
            # Load image
...
def random_perspective(image, box, params, border=(0, 0)):
    ...
    rotate[:2] = cv2.getRotationMatrix2D(center=(0, 0), angle=a, scale=s)
...
class Albumentations:
    def __init__(self):
        ...
        try:
            ...
            transforms = [albumentations.OneOf(transforms=[albumentations.ToGray(),
